...
class Game(models.Model):
    ...
    def shot_percentage(self):
        ...
        return self.our_score / self.our_shots
    ...
    def save_percentage(self):
        ...
        return 1 - self.opponent_score / self.opponent_shots
    ...
    def shot_save_percentage(self):
        ...
        return self.shot_percentage / (1 - self.save_percentage)
    ...
    def powerplay_percentage(self):
        ...
        return self.powerplay_goals / self.powerplays
    ...
    def boxplay_percentage(self):
        ...
        return self.boxplay_goals_against / self.boxplays
